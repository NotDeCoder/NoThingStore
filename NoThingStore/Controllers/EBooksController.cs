...
namespace NoThingStore.Controllers
{
    public class EBooksController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MegabyteSize,Authorship,Format,CountOfPages,Id,Name,Slug,Description,Price,IsAvailable,DownloadUrl")] EBook eBook)
        {
            if (id != eBook.Id)
            {
                return NotFound();
